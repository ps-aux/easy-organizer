...
/*Create database*/
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `the_db_name`;

/*Create user and grand him priveleges*/
GRANT ALL PRIVILEGES ON the_db_name.* TO 'tomcat'@'localhost' IDENTIFIED by 'tomcat..';
